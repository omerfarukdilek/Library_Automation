...
{
	 $yonetici_sifre = mysql_real_escape_string($_POST['yonetici_sifre']);
	 $md5_parola = md5($yonetici_sifre);
	 
	 $yonetici_kullanici = mysql_real_escape_string($_POST['yonetici_kullanici']);
	 
	 $giriskontrol = mysql_query("select * from yonetici where yonetici_kullanici ='$yonetici_kullanici' and yonetici_sifre ='$md5_parola'"); 	 
	 ...
	 if($durum)
	 {
		 ...
		 $_SESSION['yonetici_ad']    	   = $durum['yonetici_ad'];
		 $_SESSION['yonetici_soyad']       = $durum['yonetici_soyad'];
		 ...
		 echo '<meta http-equiv="refresh" content="1; url=menu.php?sayfa=">';
      ...
      <div class="control-group">
        <div class="controls">
          <div class="input-prepend">
            <span class="add-on"><i class="icon-user"></i></span><input id="input-username" name="yonetici_kullanici" type="text" placeholder="Kullanıcı Adı" />
          </div>
        </div>
      </div>
      <div class="control-group">
        <div class="controls">
          <div class="input-prepend">
            <span class="add-on"><i class="icon-lock"></i></span><input id="input-password" name="yonetici_sifre" type="password" placeholder="Şifre" />
          </div>
        </div>
      </div>
